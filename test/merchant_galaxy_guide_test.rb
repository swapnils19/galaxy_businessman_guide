...
class MerchantGalaxyGuideTest < Minitest::Test
  def test_that_it_has_a_version_number
    refute_nil ::MerchantGalaxyGuide::VERSION
  end
...
"
    guide = MerchantGalaxyGuide.get_merchants_guides(file_name: File.join(File.dirname(__FILE__), "../input.txt"))
  ...
  def test_get_roman_number
    ...
    actual_dec_number = MerchantGalaxyGuide.get_roman_number(roman_number: roman_number)
